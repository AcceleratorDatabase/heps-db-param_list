...
-- -----------------------------------------------------
-- Table `parameter_list`.`accelerator`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `parameter_list`.`accelerator` ;

CREATE TABLE IF NOT EXISTS `parameter_list`.`accelerator` (
...
CREATE TABLE IF NOT EXISTS `parameter_list`.`version` (
  ...
  CONSTRAINT `fk_acclerator_id`
    ...
    REFERENCES `parameter_list`.`accelerator` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 1
...
CREATE TABLE IF NOT EXISTS `parameter_list`.`data` (
  ...
  `devicetype_id` INT(11) NULL DEFAULT NULL,
  ...
  INDEX `fk_device_id_idx` (`devicetype_id` ASC),
...
CREATE TABLE IF NOT EXISTS `parameter_list`.`re_system_subsystem` (
  ...
  INDEX `fk_system_id_idx` (`system_id` ASC),
  INDEX `fk_subsystem_id_idx` (`subsystem_id` ASC),
  CONSTRAINT `ffk_subsystem_id`
    FOREIGN KEY (`subsystem_id`)
    REFERENCES `parameter_list`.`subsystem` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `ffk_system_id`
    FOREIGN KEY (`system_id`)
    REFERENCES `parameter_list`.`system` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
